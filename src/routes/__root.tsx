...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Amit Mortgages — GTA Mortgage Agent | Ontario" },
      { name: "description", content: "Independent mortgage agent serving the Greater Toronto Area. Access to 50+ lenders, sharp rates, and personal advice for buying, renewing, or refinancing." },
      { name: "author", content: "Amit Mortgages" },
      ...
      { property: "og:site_name", content: "Amit Mortgages" },
